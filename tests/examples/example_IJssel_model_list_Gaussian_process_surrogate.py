"""
Script for testing the Model List Gaussian Process surrogate class. GPyTorch
is used to handle a list of GP's, each with a single output (extend to vector outputs?)
and common input points. Not all features are necessarily used in every GP.
