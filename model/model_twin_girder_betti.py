...
from modules.IJssel_bridge_utils import load_pickle, paths
...
class IJssel_bridge_model:
    def __init__(
        ...
        fname = (
            paths["model_data"]
            + f"model_dict#max_elem_length={self.max_elem_length}#E={self.E}.pickle"
        )
        model_properties = load_pickle(fname)
