...
import numpy as np
from sampling.cv_voronoi import CVVoronoi
from sklearn.metrics import mean_squared_error

from harlow.surrogating.surrogate_model import VanillaGaussianProcess
from harlow.utils.helper_functions import latin_hypercube_sampling, mean_absolute_error
from tests.integration_tests.test_functions import peaks_2d, peaks_2d_multivariate
...
def test_2D_cvVoronoi_sampling(
    ...
    lv = CVVoronoi(
        ...
        evaluation_metric=[rmse, mean_absolute_error],
        run_name="test",
    )
